...
//structure to represeent weighted edge in graph  
class Edge  
{  
    public: 
    int src, dest, weight;  
...
{  
    // find root and make root the parent of i 
...
// Compare two edges w.r.t weights.  
...
// main function for MST
void KruskalMST(Graph* graph)  
{  
    int V = graph->V;  
    Edge result[V]; // for resultant MST  
    int e = 0; // index variable used for result[]  
    int i = 0; // variable used for sorted edges  
